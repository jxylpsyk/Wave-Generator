...
txtbx1 = tk.Button(root,width=12,height=2,text="Square",background = '#2600ff',foreground="#ffffff",command = make_default_wave('square',5000,1))
...
txtbx1 = tk.Button(root,width=12,height=2,text="Triangle",background='#c800ff',foreground="#ffffff",command = make_default_wave('triangle',5000,1))
txtbx1.grid(column = 1,row = 35)

txtbx1 = tk.Button(root,width=12,height=2,text="Sine",background= '#c800ff',foreground="#ffffff",command = make_default_wave('sin',5000,1))
